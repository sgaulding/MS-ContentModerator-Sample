...
//small but important modification to class https://github.com/zzzprojects/html-agility-pack/blob/master/src/Samples/Html2Txt/HtmlConvert.cs
    public static class HtmlParser
    {
        ...
        internal static void ConvertContentTo(HtmlNode node, TextWriter outText, PrecedingDomTextInfo textInfo)
        {
            foreach (var subnode in node.ChildNodes) ConvertTo(subnode, outText, textInfo);
        }
        ...
        internal static void ConvertTo(HtmlNode node, TextWriter outText, PrecedingDomTextInfo textInfo)
        {
            string html;
            switch (node.NodeType)
            {
                ...
                case HtmlNodeType.Text:
                    ...
                    if (textInfo.LastCharWasSpace == char.IsWhiteSpace(html[html.Length - 1])) outText.Write(' ');
                ...
                case HtmlNodeType.Element:
                    ...
                    if (endElementString != null) outText.Write(endElementString);
